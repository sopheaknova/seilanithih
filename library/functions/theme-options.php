...
/* ------------------------------------ */
	'settings'        => array(
		...
		array(
			...
			'std'		=> '©2014 Seilanithih Microfinance Institutiion. All Rights Reserved.',
			'type'		=> 'text',
			'section'	=> 'footer'
		),
		// Footer: Credit
		...
		array(
			'id'		=> 'layout-team',
			'label'		=> 'Team',
			'desc'		=> '[ <strong>is_team</strong> ] Team post layout - If a post has a set layout, it will override this.',
			'std'		=> 'inherit',
			'type'		=> 'radio-image',
			'section'	=> 'layout',
			'choices'	=> array(
		...
		array(
			'id'		=> 'layout-service',
			'label'		=> 'Service',
			'desc'		=> '[ <strong>is_service</strong> ] Service post layout - If a post has a set layout, it will override this.',
			'std'		=> 'inherit',
			'type'		=> 'radio-image',
			'section'	=> 'layout',
			'choices'	=> array(
		...
		array(
			'id'		=> 's1-team',
			'label'		=> 'Team',
			'desc'		=> '[ <strong>is_team</strong> ] Primary - If a team post has a unique sidebar, it will override this.',
			'type'		=> 'sidebar-select',
			'section'	=> 'sidebars'
		),
		array(
