...
function sp_slider_shortcode_ajax(){
	...
	<div id="sc-slider-form">
			<table id="sc-slider-table" class="form-table">
				<tr>
					<?php $field = 'slide_style'; ?>
					<th><label for="<?php echo $field; ?>"><?php _e( 'Slider style', 'sptheme_admin' ); ?></label></th>
					<td>
						<select name="<?php echo $field; ?>" id="<?php echo $field; ?>">
							<option value="1" selected><?php _e( 'Basic Slider', 'sptheme_admin' ); ?></option>
							<option value="2"><?php _e( 'Slider with thumbnail', 'sptheme_admin' ); ?></option>
						</select>
					</td>
				</tr>
				<tr>
