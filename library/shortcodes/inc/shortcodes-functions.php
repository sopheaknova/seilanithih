...
function sp_slider_sc( $atts, $content = null ){
	...
	while ($custom_query->have_posts()) :
		...
		$out .= sp_sliders($slide_style, $slide_id, 'post-slider');
	endwhile;
...
function sp_client_sc( $atts, $content = null ){
	...
	return sp_get_client( $style, $numberposts );
...
function sp_branch_sc( $atts, $content = null ){
	...
	return sp_get_branch_by_tax( $category_id, $numberposts );
...
/* FAQs shortcode
/*--------------------------------------------------------------------------------------*/
function sp_faq_sc( $atts, $content = null ){
